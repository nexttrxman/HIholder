-- =============================================
-- TronKeeper + TON Claims Schema (SELF-HOSTED / VPS)
-- =============================================
-- Derivado de /supabase/schema.sql con 2 cambios:
--   1. Sin pg_cron (no existe en postgres oficial).
--      La expiración la ejecuta el contenedor "scheduler"
--      llamando a expire_claims_and_cycles() cada minuto.
--   2. + pg_stat_statements para analizar queries lentas.
-- =============================================
...
-- =============================================
-- HOLD CYCLES TABLE (cada ciclo dura 8 horas)
-- =============================================
...
CREATE TABLE IF NOT EXISTS claims (
  ...
  total_prize DECIMAL(18, 8) NOT NULL,
  ton_fee DECIMAL(18, 8) NOT NULL,
...
-- =============================================
-- FUNCIÓN: Expirar claims y ciclos vencidos
-- (la ejecuta el contenedor "scheduler" cada minuto
--  vía POST /rpc/expire_claims_and_cycles)
-- =============================================
